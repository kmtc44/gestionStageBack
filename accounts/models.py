...
class Student(models.Model):
    ...
    def __str__(self):
        return self.status + " : =>  " + self.first_name + " " + self.last_name + " " + self.classe + " " + self.department
...
class Teacher(models.Model):
    ...
    status = models.CharField(max_length=20, default="teacher")

    def __str__(self):
        return self.status + " : =>  " + self.first_name + " " + self.last_name + " " + self.department
...
class Framer(models.Model):
    ...
    status = models.CharField(max_length=20, default="framer")

    def __str__(self):
        return self.status + " : =>  " + self.firstname + " " + self.last_name + " " + self.department
